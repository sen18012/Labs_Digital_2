...
//#################### NIVEL 1 IZQUIERDA J2 ###############################//
    case 1:
      switch(posicion_J2){
        ...
        case 3:
          for(int x = 56+160; x >8+160; x = x-1){
...
switch(posicion_J2){
        ...
        for(int x = 128+160; x >88+160; x = x-1){
          ...
          FillRect(88+160, 144, 24, 24, 0x0000);
        ...
        case 22:
          for(int x = 48+160; x >40160; x = x-1){
             LCD_Sprite(x,0,24,24,J2_Abajo_Derecha,1,0,1,0);
             V_line( x + 24, 0, 24, 0x0000);
            }
    ...
    case 3:
      switch(posicion_J2){
        ...
        case 3:
          ...
          FillRect(8+160, 192, 24, 24, 0x0000);
          LCD_Sprite(128+160,216,24,24,J2_Abajo_Derecha,1,0,1,0);            
          posicion_J2 = 0;
          b_LEFT_J2 = LOW;
...
//#################### NIVEL 2 DERECHA J1 ###############################//
    case 2:
      switch(posicion_J1){
        ...
        case 21:
          b_RIGHT_J1 = LOW;
        break; //break pos 21 /RIGTH/N2/J1
        ...
        case 23:
          b_RIGHT_J1 = LOW;
        break; //break pos 23 /RIGTH/N2/J1
        
        case 24:
          b_RIGHT_J1 = LOW;
        break; //break pos 24 /RIGTH/N2/J1
      }    
...
//#################### NIVEL 3 DERECHA J1 ###############################//
    case 3:
      switch(posicion_J1){
        ...
        case 9:
          FillRect(128, 112, 24, 24, 0x0000);
          LCD_Sprite(128,216,24,24,J1_Abajo_Derecha,1,0,1,0);           
          posicion_J1 = 0;        
          b_RIGHT_J1 = LOW;
        break; //break pos 9 /RIGTH/N33/J1
    ...
    case 3:
      switch(posicion_J2){
        ...
        case 6:
          ...
          FillRect(128, 184, 24, 24, 0x0000);
          LCD_Sprite(8,216,24,24,J2_Abajo_Derecha,1,0,1,0);           
          posicion_J2 = 0;
          b_RIGHT_J2= LOW;
        ...
        case 9:
          FillRect(128+160, 112, 24, 24, 0x0000);
          LCD_Sprite(128+160,216,24,24,J2_Abajo_Derecha,1,0,1,0);           
          posicion_J2 = 0;        
          b_RIGHT_J2 = LOW;
        break; //break pos 9 /RIGTH/N33/J2
        ...
        case 11:
          b_RIGHT_J2 = LOW;
        break; //break pos 11 /RIGTH/N3/J2
