  ...
  while (JUEGO_EN_PROGRESO == HIGH){
    ...
    switch (nivel){
      case 1:
        ...
        Mapa_nivel(1);
        while (ganar_N1 != HIGH){
          String Str_estrellas_J1 = String(STARS_N1_J1);
          String Str_estrellas_J2 = String(STARS_N1_J2);
      ...
      case 2:
        ...
        while(ganar_N2 != HIGH){
          String Str_estrellas_J1 = String(STARS_N2_J1);
          String Str_estrellas_J2 = String(STARS_N2_J2);
          LCD_Print(Str_estrellas_J1, 16, 8, 2, 0x07FF, 0x0000);
          LCD_Print(Str_estrellas_J2, 16+160, 8, 2, 0x07FF, 0x0000);
      ...
      case 3:
        ...
        posicion_J2 = 0;
        while(ganar_N3 != HIGH){
          String Str_estrellas_J1 = String(STARS_N3_J1);
          String Str_estrellas_J2 = String(STARS_N3_J2);
          LCD_Print(Str_estrellas_J1, 104, 0, 2, 0x07FF, 0x0000);
          LCD_Print(Str_estrellas_J2, 104+160, 0, 2, 0x07FF, 0x0000);
